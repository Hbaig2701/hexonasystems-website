...
export const EVIDENCE_FAQS: Faq[] = [
  ...
  },
  {
    ...
    answer:
      'Reference conversations are arranged case by case with the client’s permission, and we ask rather than assume. If a reference in your sector matters to your decision, raise it on the call and we will tell you plainly whether we can arrange one instead of implying we can.',
  },
  {
    question: 'What can we rely on while the records are empty?',
    answer:
