 ...
 *
 * ⚠️ .mts, NOT .ts. As .ts it is loaded as CommonJS, and Vite warns that ESM
 * syntax in it is unsupported by the config loader that becomes the default in
 * a future major. The extension is the fix.
 *
